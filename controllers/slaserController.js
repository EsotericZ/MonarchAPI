    ...
    sql.connect(config, function (err) {
      ...
      request.query(`
        ...
        function (err, recordset) {
          ...
          // Map the jobData to include any additional information from TLJobs and maintain sorting
          ...
          // Re-sort by DueDate and JobNo after combining to ensure the order is preserved
          fullJob.sort((a, b) => {
